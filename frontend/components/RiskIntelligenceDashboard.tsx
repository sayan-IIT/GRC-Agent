      ...
      <section className="border-b border-[#d9ded2] bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-normal text-ink md:text-5xl">TPRM / Risk Intelligence Scan</h1>
            <p className="mt-3 max-w-2xl text-base text-[#546259]">
              Human Review Dashboard - AI Agents enabled by webhooks with Actions To be Taken
            </p>
          </div>
          <button
            onClick={() => load()}
            title="Reload risks and proposed scores from the backend"
            aria-label="Reload dashboard data from the backend"
